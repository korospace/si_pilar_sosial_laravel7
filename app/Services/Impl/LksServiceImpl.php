    ...
    public function createLks(LksRequest $request): JsonResponse
    {
        try {
            ...
            $newLks = Lks::create([
                ...
                'jenis_lks'                         => $request->jenis_lks ? $request->jenis_lks : null,
                'jumlah_wbs'                        => $request->jumlah_wbs ? $request->jumlah_wbs : 0,
                'jumlah_peksos'                     => $request->jumlah_peksos ? $request->jumlah_peksos : 0,
                ...
                'induk_berusaha_status'             => $request->induk_berusaha_status ? $request->induk_berusaha_status : null,
