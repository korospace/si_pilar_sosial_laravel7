                            ...
                            <div class="form-group">
                                ...
                                <select id="year" name="year" class="custom-select select2bs4">
                                    ...
                                    @for ($year = date('Y'); $year >= 2000; $year--)
                                        @if ($psm != null)
                                            <option value="{{ $year }}" {{ $year == $psm->year ? 'selected' : '' }}>{{ $year }}</option>
                                        @else
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="alamat_rt" name="alamat_rt" placeholder="001" value="{{ $psm != null ? $psm->alamat_rt : '' }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="alamat_rw" name="alamat_rw" placeholder="001" value="{{ $psm != null ? $psm->alamat_rw : '' }}">
