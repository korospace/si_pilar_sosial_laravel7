...
@section('dashboard-wraper.content')
    @include('components/dashboard-head', ['headTitle' => 'Master Akreditasi LKS', 'headPage' => 'Akreditasi LKS'])
		...
		<div class="container-fluid">
            ...
            <div class="row mb-4 px-2">
				<div class="col-12 d-flex justify-content-end">
                    <a href="{{ route('akreditasi_lks.create') }}" class="btn btn-block btn-secondary btn-md" style="width: max-content;">
