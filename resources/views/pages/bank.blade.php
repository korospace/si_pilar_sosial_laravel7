...
@section('dashboard-wraper.content')
    @include('components/dashboard-head', ['headTitle' => 'Master Bank', 'headPage' => 'Bank'])
		...
		<div class="container-fluid">
            ...
            <div class="row mb-4 px-2">
				<div class="col-12 d-flex justify-content-end">
                    <a href="{{ route('bank.create') }}" class="btn btn-block btn-secondary btn-md" style="width: max-content;">
				...
				<div class="col-12">
                    <div class="card card-secondary card-outline">
						<div class="card-header">
							<table id="tableBank" class="table table-bordered table-hover">
								<thead>
									<tr>
										<th>
											No
