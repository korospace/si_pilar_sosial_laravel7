...
@push('dashboard-wraper.jscript')
    ...
    <script src="{{ asset('js/pages/lks.js') }}"></script>
@endpush

@section('dashboard-wraper.content')
    @include('components/dashboard-head', ['headTitle' => 'LEMBAGA KESEJAHTERAAN SOSIAL', 'headPage' => 'lks'])
		...
		<div class="container-fluid">
            ...
            <div class="row mb-4 px-2">
                <div class="col-12 d-flex align-items-end justify-content-end">
                    ...
                    <a href="{{ route('lks.create') }}" class="btn btn-block btn-secondary btn-md mr-2" style="width: max-content;">
                        <i class="fa fa-plus"></i> &nbsp; tambah
                    </a>
                    @endif
                    @if (in_array($user->level_id, [1,3]))
                    <a href="" class="btn btn-block btn-secondary btn-md" style="width: max-content;" data-toggle="modal" data-target="#modal-import-lks">
    ...
    {{-- modal import --}}
    <div class="modal fade" id="modal-import-lks">
        <div class="modal-dialog">
            <form id="formImportLks" class="modal-content" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-12" autocomplete="off" style="position: relative;">
                            ...
                            <div class="form-group">
                                <label for="file_lks"><small><b>File</b></small></label>
                                <input type="file" class="form-control-file" id="file_lks" name="file_lks">
                                <span id="file_lks-error" class="invalid-feedback"></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer justify-content-end">
                    <a target="_blank" href="{{ asset('template_import/lks_import.xls') }}" class="btn btn-info">
    ...
    {{-- modal filter --}}
    <div id="modal-filter-lks" class="modal fade modal-filter">
        <div class="modal-dialog">
            <form id="formFilterLks" class="modal-content" autocomplete="off">
                <div class="modal-header">
                ...
                <div class="modal-footer justify-content-end">
                    <button type="button" class="btn btn-info btn-clear-filter" onclick="clear_filter_lks()">Clear</button>
                    <button type="button" class="btn btn-success" onclick="run_filter_lks()">Submit</button>
                </div>
            </form>
        </div>
    </div>
