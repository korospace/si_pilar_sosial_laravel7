                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="alamat_rt" name="alamat_rt" placeholder="001" value="{{ $lks != null ? $lks->alamat_rt : '' }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="alamat_rw" name="alamat_rw" placeholder="001" value="{{ $lks != null ? $lks->alamat_rw : '' }}">
