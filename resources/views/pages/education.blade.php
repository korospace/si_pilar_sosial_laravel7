...
@push('dashboard-wraper.jscript')
    ...
    <script src="{{ asset('js/pages/education.js') }}"></script>
@endpush

@section('dashboard-wraper.content')
    @include('components/dashboard-head', ['headTitle' => 'Master Pendidikan', 'headPage' => 'Pendidikan'])
		...
		<div class="container-fluid">
            ...
            <div class="row mb-4 px-2">
				<div class="col-12 d-flex justify-content-end">
                    <a href="{{ route('education.create') }}" class="btn btn-block btn-secondary btn-md" style="width: max-content;">
				...
				<div class="col-12">
                    <div class="card card-secondary card-outline">
						<div class="card-header">
							<table id="tableEducation" class="table table-bordered table-hover">
								<thead>
									<tr>
										<th>
											No
