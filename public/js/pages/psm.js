...
function initialDataTablePsm(params) {
    ...
    $("#tablePsm")
        ...
        .buttons()
        .container()
        .appendTo("#tablePsm_wrapper .col-md-6:eq(0)");
    ...
    $("#tablePsm_nonaktif")
        ...
        .buttons()
        .container()
        .appendTo("#tablePsm_nonaktif_wrapper .col-md-6:eq(0)");
}
...
$(".nav-tabs a").on("shown.bs.tab", function (event) {
    ...
    if (href == "#div_nonaktif") {
        $("#formFilterPsm #status_filter_wraper").hide();
    } else {
        $("#formFilterPsm #status_filter_wraper").show();
    }
...
$("#download_excel").on("click", function (event) {
    ...
    $.ajax({
        type: "GET",
        url: `${BASE_URL}/api/v1/psm/download_excel`,
        headers: {
            token: $token,
        },
        success: function (data) {
